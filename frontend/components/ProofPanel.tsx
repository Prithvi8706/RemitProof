  ...
  return (
    <section aria-labelledby="proof-title">
      <div className="mb-4 flex items-center justify-between gap-4">
        <div>
          <h2 id="proof-title" className="text-xl font-semibold tracking-[-0.02em] text-ink">Resolution proof</h2>
          <p className="mt-1 text-sm text-muted">The authorization certificate generated by deterministic code.</p>
        </div>
        {sufficiency && (
