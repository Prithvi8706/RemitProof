  ...
  return (
    <div className="min-h-screen bg-canvas">
      ...
      <main className="mx-auto max-w-[720px] px-4 py-20 sm:px-6">
        ...
        <h1 className="mt-5 text-3xl font-semibold tracking-[-0.03em] text-ink">Page not found</h1>
        <p className="mt-3 text-sm leading-6 text-muted">The requested page does not exist or is no longer available.</p>
        <Link
          href="/"
